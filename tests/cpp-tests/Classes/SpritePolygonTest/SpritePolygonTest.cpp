...
void SpritePolygonTestDemo::initDefaultSprite(const std::string &filename, cocos2d::experimental::SpritePolygon * inst)
{
    ...
    debugForNormalSprite->drawPoints(positions, 4, 8, cocos2d::Color4F(0.0,1.0,1.0,1.0));
    debugForNormalSprite->drawLine(positions[0], positions[1], cocos2d::Color4F::GREEN);
    debugForNormalSprite->drawLine(positions[1], positions[2], cocos2d::Color4F::GREEN);
    debugForNormalSprite->drawLine(positions[2], positions[3], cocos2d::Color4F::GREEN);
    debugForNormalSprite->drawLine(positions[3], positions[0], cocos2d::Color4F::GREEN);
    debugForNormalSprite->drawLine(positions[0], positions[2], cocos2d::Color4F::GREEN);
    debugForNormalSprite->setVisible(false);
